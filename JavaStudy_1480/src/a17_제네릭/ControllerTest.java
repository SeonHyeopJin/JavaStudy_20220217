...
public class ControllerTest {
	...
	public CMRespDto<? extends User> getProfile(String username){
		PersonalUser personalUser = new PersonalUser("seonhyeop", "1234", "진선협", "s@gmail.com", "a20220001");
	...
	public CMRespDto<?> login(String username, String password){
		User userEntity = User.builder()
				               								.username("seonhyeop")
	  	                       								.password("1234")
	  	                       								.name("진선협")
	  	                       								.email("seonhyeop@gmail.com")
	  	                       								.build();
						
							  	
		User user = new User("seonhyeop", "1234", null, null);					  		
	...
	public static void main(String[] args) {
		...
		System.out.println(test.login("seonhyeop1", "1111"));
